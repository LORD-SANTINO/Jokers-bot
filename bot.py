...
TOKEN = '8338265637:AAG7zi_nXgOzhPqeRjYLQkYRQTK-p85jNb8'  # Your bot token here
...
EMAIL_TEMPLATES = {
    ...
    "fackaccount": "مرحباً، أبلغ عن هذا الرقم لأنه يستخدم حساباً مزيفاً: {number}. يرجى التحقق.",
